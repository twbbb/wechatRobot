...
@Table(name = "wechat_qa_message_his") // @Table来指定和哪个数据表对应;如果省略默认表名就是user；
public class WechatQaMessageHis
{
	...
	private String answerText = "";//回复内容
	private String answerFlag = "";// 回复标示 0或空，待回复 1.已回复 2.不回复 3.已失效 
	@Temporal(TemporalType.TIMESTAMP)
